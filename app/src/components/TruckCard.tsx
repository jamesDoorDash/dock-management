...
function PrismMoreHorizontalIcon({ className, color }: { className?: string; color?: string }) {
  return (
    <svg
      className={className}
      width="16"
      ...
      aria-hidden
    >
      <path d="M4.5 8C4.5 8.9665 3.7165 9.75 2.75 9.75C1.7835 9.75 1 8.9665 1 8C1 7.0335 1.7835 6.25 2.75 6.25C3.7165 6.25 4.5 7.0335 4.5 8Z" />
      <path d="M9.75 8C9.75 8.9665 8.9665 9.75 8 9.75C7.0335 9.75 6.25 8.9665 6.25 8C6.25 7.0335 7.0335 6.25 8 6.25C8.9665 6.25 9.75 7.0335 9.75 8Z" />
      <path d="M15 8C15 8.9665 14.2165 9.75 13.25 9.75C12.2835 9.75 11.5 8.9665 11.5 8C11.5 7.0335 12.2835 6.25 13.25 6.25C14.2165 6.25 15 7.0335 15 8Z" />
    </svg>
  );
}
...
export function TruckCard({
  ...
  if (figmaCard && (variant === "scheduled" || variant === "compact")) {
    ...
    return (
      <div
        onPointerDown={onPointerDown}
        className="group relative h-full w-full flex flex-col gap-[2px] cursor-grab active:cursor-grabbing touch-none rounded-[8px] pl-1 pr-1.5 py-1.5 transition-shadow hover:shadow-[0_2px_4px_rgba(25,25,25,0.2)] overflow-hidden"
        style={{ backgroundColor: palette.bg }}
      >
        {/* Title row */}
          ...
          {showMenu && (
            ...
            >
              {menuVariant === "info" ? (
                ...
                <PrismMoreHorizontalIcon className="size-4" />
              )}
            </button>
          )}
        </div>
