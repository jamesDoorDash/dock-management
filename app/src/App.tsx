    ...
    <div className={"h-full flex bg-white" + (version === "v34" || version === "v35" || version === "v36" || version === "v37" || version === "v38" || version === "v39" ? " typefix" : "")}>
      ...
      <main className="flex-1 min-w-0 flex flex-col overflow-y-auto">
        {adminOpen ? (
          ...
          <DockManagementV3 treatment={versionToTreatment(version)} typefix={version === "v34" || version === "v35" || version === "v36" || version === "v37" || version === "v38" || version === "v39"} declutter={version === "v35" || version === "v36" || version === "v37" || version === "v38" || version === "v39"} legendAttached={version === "v36" || version === "v37" || version === "v38" || version === "v39"} redLate={version === "v37"} autoReassignLabel={version === "v36" || version === "v37" || version === "v38" || version === "v39"} prismIcon={version === "v39"} />
        )}
      </main>
    </div>
  );
